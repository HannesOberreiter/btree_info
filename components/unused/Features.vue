<template>
  <section class="bg-white border-b py-8">
    <div class="container max-w-5xl mx-auto m-8">
      ...
      >
        <img slot="svg" src="~assets/img/travel-booking.svg" />
      </feature-right>
      <feature-left
        headline="Lorem ipsum dolor sit amet"
        content="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam at ipsum eu nunc commodo posuere et sit amet ligula."
...
<script>
import FeatureRight from '@/components/global/FeatureRight'
import FeatureLeft from '@/components/global/FeatureLeft'
