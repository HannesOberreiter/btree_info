<template>
  <div class="flex-1 flex items-center justify-between">
    ...
    <nav class="relative z-0 inline-flex rounded-md shadow-sm -space-x-px" aria-label="Pagination">
      <a href="#" :class="modelValue <= 0 ? 'link-disabled' : ''" @click.prevent="modelValue = 0"
      ...
      <a href="#" :class="modelValue <= 0 ? 'link-disabled' : ''" @click.prevent="modelValue = modelValue - 5"
        class="relative inline-flex items-center px-2 py-2 rounded-l-md border border-gray-300 bg-white text-sm font-medium text-gray-500 hover:bg-gray-50 dark:bg-gray-700 dark:text-gray-50">
        <span class="sr-only">Previous</span>
      ...
      <a href="#" :class="modelValue + 5 >= length ? 'link-disabled' : ''" @click.prevent="modelValue = modelValue + 5"
      ...
      <a href="#" :class="modelValue + 5 >= length ? 'link-disabled' : ''"
