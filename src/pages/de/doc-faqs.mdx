...
Die meisten der von Ihnen gelöschten Daten sind nicht wiederherstellbar. Es gibt einige Ausnahmen wie z.B. Aufgaben (Fütterungen, Behandlungen, Kontrollen, Ernten), die bis zu einem Monat nach dem Löschen wiederhergestellt werden können. Für die Wiederherstellung gehen Sie auf die Tabellenseite und wählen Sie das Dropdown-Menü, hier können Sie gelöschte Daten sichtbar machen und auch wiederherstellen.
...
Hinweis: Da wir uns um die Datenbereinigung kümmern, werden Konten, die 5 Jahre lang inaktiv waren, automatisch und ohne Ankündigung gelöscht!
