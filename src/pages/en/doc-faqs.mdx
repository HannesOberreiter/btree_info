...
Most of the data you delete is not recoverable. There are some expection as for example tasks (feedings, treatments, checkups, harvests), which can be restored up to one month after deletion. For recovery go to the table page and choose the dropdown button menu, here you can toggle the visibility of deleted data and choose to restore them.
...
Hint: As we care about data cleaning, accounts which were inactive for 5 years are automatically delete without any notice!
